...
namespace Koffeinfrei.Base
{
    public static class KfColor
    {
        ...
        public static Color FromHexCodeAndAlpha(string hexCode, string alpha)
        {
            ...
            int r = KfInteger.FromHex(hexCode.Substring(0, 2));
            int g = KfInteger.FromHex(hexCode.Substring(2, 2));
            int b = KfInteger.FromHex(hexCode.Substring(4));
